...
Plugin URI: #
Description: Creates a sidebar widget that displays the latest twitter updates for any user with public tweets using v1.1 API
Author: Josip Opacic
Version: 0.1
Author URI: http://twitter.com/jopacicdev
*/
...
<?php
	...
	function widget($args, $instance) {
		...
		$dir = plugins_url('twitter-proxy.php', __FILE__);
		// $jsonURL = "http://api.twitter.com/1/statuses/user_timeline.json?screen_name=$username&include_entities=true";
		$jsonURL = $dir . "?url=statuses/user_timeline.json?screen_name=" . $username;
